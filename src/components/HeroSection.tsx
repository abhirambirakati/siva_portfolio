      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <a
              href="https://github.com/sivabevara45"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 rounded-full border border-border text-muted-foreground hover:text-foreground transition-colors"
            >
              <Github size={18} />
            </a>

            <a
              href="https://www.linkedin.com/in/siva45"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 rounded-full border border-border text-muted-foreground hover:text-foreground transition-colors"
            >
